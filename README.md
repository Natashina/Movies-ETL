...
However, in the future iterations the code could throw a error. We can use "try except" blocks here to print the error message and ensure Challenge_Function will continue running.
